        ...
        <div className="container-fluid section3">
            <div className="row d-flex justify-content-center carousel">
                ...
                <div className=" col-md-3 col-12 row ">
                    <h1 className="text-center">Sabe aquela ideia que você teve para seu negócio?<EmojiObjectsOutlinedIcon className="ml-2" style={{ fontSize: 40 }} color="secondary" /></h1>
